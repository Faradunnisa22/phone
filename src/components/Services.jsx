...
const Services = () => {
    const services = [
        { id: 1, title: "Membership Organisations", description: "Our membership management software provides ful automation of membership renewals and payments", image: "/src/assets/organisation.png" },
        { id: 2, title: "National Associations", description: "Our membership management software provides ful automation of membership renewals and payments", image: "/src/assets/association.png" },
        { id: 3, title: "Clubs And Groups", description: "Our membership management software provides ful automation of membership renewals and payments", image: "/src/assets/group.png" },
    ]
